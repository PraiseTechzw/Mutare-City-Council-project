      ...
      {activities.map((activity) => (
        ...
        >
          <div className="flex items-start gap-4">
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${getActivityColor(activity.type).split(" ")[0]}`}>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-4 mb-2">
                ...
                <div className="text-right flex-shrink-0">
                  {activity.amount && (
                    <p className="text-lg font-bold text-white mb-1">${activity.amount.toFixed(2)}</p>
                  )}
